...
from .views import SubEventCreateAPIView,SubEventListAPIView,MainEventListAPIView,CollegeAPIView
...
urlpatterns = [
    ...
    path('college/', CollegeAPIView.as_view(), name='sub-event-list'),
]
